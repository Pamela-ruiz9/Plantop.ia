...
export default function Home() {
  return (    <div className="min-h-screen flex flex-col items-center justify-between p-8 bg-gradient-to-b from-green-50 to-white">      <header className="w-full flex justify-center mb-6">
      ...
      <main className="flex flex-col items-center gap-8 w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mt-4">          <Link href="/dashboard" className="rounded-xl shadow-md bg-white hover:bg-green-50 p-6 flex flex-col items-center transition border border-green-100">
          ...
          </Link>          <Link href="/plants/add" className="rounded-xl shadow-md bg-white hover:bg-green-50 p-6 flex flex-col items-center transition border border-green-100">
            <svg className="w-10 h-10 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          </Link>          <Link href="/plants" className="rounded-xl shadow-md bg-white hover:bg-green-50 p-6 flex flex-col items-center transition border border-green-100">
            <svg className="w-10 h-10 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
