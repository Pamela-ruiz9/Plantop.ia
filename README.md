...
- **Login con Google (OAuth)** — verificado con clic real: Pame entró exitosamente en producción (15 julio 2026)
...
### ⏳ Pendiente
- Verificación de clics reales en navegador para el resto del CRUD (login con Google ya confirmado)
